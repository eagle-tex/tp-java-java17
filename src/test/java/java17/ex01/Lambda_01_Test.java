...
public class Lambda_01_Test {
  ...
  public void test_filter_by_password() throws Exception {
    ...
    // TODO result ne doit contenir que les personnes dont l'age est > 49 et dont le hash du mot de
    // passe correspond à la valeur de la variable passwordSha512Hex
